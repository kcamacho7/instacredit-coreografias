...
import { HistoricoAcuerdosTab } from './HistoricoAcuerdosTab'
...
export function RegionalPanel({ areaNegocio }: RegionalPanelProps) {
  ...
  if (puedeGestionar) {
    ...
    secciones.push({ id: 'historico', nombre: 'Histórico de acuerdos' })
  }
  ...
  return (
    <div style={{ paddingTop: 20 }}>
      ...
      {subTab === 'historico' && puedeGestionar && <HistoricoAcuerdosTab areaNegocio={areaNegocio} />}
